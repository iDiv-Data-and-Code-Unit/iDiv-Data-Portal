...
namespace IDIV.Modules.Idiv.UI
{
    public class IdivModule : ModuleBase
    {
        public IdivModule() : base("IDIV")
        {
            LoggerFactory.GetFileLogger().LogCustom("...ctor of idiv...");
        }
        public override void Install()
        {
            LoggerFactory.GetFileLogger().LogCustom("...start install of idiv...");
            try
            {
                base.Install();
                ...
                if (!operationManager.Exists("IDIV", "Content", "*"))
                    operationManager.Create("IDIV", "Content", "*");
            ...
            LoggerFactory.GetFileLogger().LogCustom("...end install of idiv...");
